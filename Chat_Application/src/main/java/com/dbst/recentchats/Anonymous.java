 ...
 * 
 */
public class Anonymous extends BulkImages {

	public AndroidDriver<AndroidElement> AnonymousBulkImages() throws MalformedURLException, InterruptedException{
		AndroidDriver<AndroidElement> driver = BulkImage();
